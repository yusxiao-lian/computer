<template>
    <div>
        ...
        <div class="bottom_box">
            ...
            <div class="menu">
                <div @click="toHome" class="pointer">Home</div>
                <div @click="toInvitation" class="contact pointer">INVITATIONS</div>
